/**
 * TransactionListQuery の PostgreSQL 実装
...
export interface PostgresTransactionListQueryDeps {
  resolveCategoryNames: ResolveCategoryNames
  resolveViewerRole: ResolveViewerRole
}

export class PostgresTransactionListQuery implements TransactionListQuery {
  constructor(
    private readonly db: Db,
    private readonly deps: PostgresTransactionListQueryDeps,
  ) {}
