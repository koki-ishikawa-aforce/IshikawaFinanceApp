/**
 * ProratedChildTransactionRepository の PostgreSQL 実装
...
export class PostgresProratedChildTransactionRepository implements ProratedChildTransactionRepository {
