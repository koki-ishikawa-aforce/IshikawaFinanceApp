/**
 * ExpenseSettlementManagementQuery の PostgreSQL 実装
...
export interface PostgresExpenseSettlementManagementQueryDeps {
  /** 「当月」の基準時刻（テスト決定性のため注入） */
  now: () => Date
}

export class PostgresExpenseSettlementManagementQuery implements ExpenseSettlementManagementQuery {
  constructor(
    private readonly db: Db,
    private readonly deps: PostgresExpenseSettlementManagementQueryDeps,
  ) {}
