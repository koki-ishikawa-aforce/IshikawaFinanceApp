/**
 * ExpenseReimbursementDepositRepository の PostgreSQL 実装
...
export class PostgresExpenseReimbursementDepositRepository implements ExpenseReimbursementDepositRepository {
