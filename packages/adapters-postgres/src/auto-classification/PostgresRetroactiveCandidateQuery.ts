...
export interface PostgresRetroactiveCandidateQueryDeps {
  /** View の proposedAt に使う現在時刻（テスト決定性のため注入） */
  now: () => Date
}

export class PostgresRetroactiveCandidateQuery implements RetroactiveCandidateQuery {
  constructor(
    private readonly db: Db,
    private readonly deps: PostgresRetroactiveCandidateQueryDeps,
  ) {}
