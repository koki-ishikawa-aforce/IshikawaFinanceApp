/**
 * AmazonProductKeyLearningRuleRepository の PostgreSQL 実装
...
export class PostgresAmazonProductKeyLearningRuleRepository implements AmazonProductKeyLearningRuleRepository {
