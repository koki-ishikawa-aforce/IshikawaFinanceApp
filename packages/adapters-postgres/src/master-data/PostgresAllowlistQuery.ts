/**
 * AllowlistQuery の PostgreSQL 実装
...
export interface PostgresAllowlistQueryDeps {
  resolveParameterStoreValue: ResolveParameterStoreValue
}

export class PostgresAllowlistQuery implements AllowlistQuery {
  constructor(
    private readonly db: Db,
    private readonly deps: PostgresAllowlistQueryDeps,
  ) {}
