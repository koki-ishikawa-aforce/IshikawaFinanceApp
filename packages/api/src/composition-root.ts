...
import {
  ...
  PostgresConsecutiveFailureCounterRepository,
  PostgresDeliveryMessageRepository,
  PostgresFailsafeEmailRepository,
  PostgresLineChannelConfigQuery,
  PostgresLineDeliveryLogRepository,
  PostgresDashboardQuery,
  PostgresDailyMailImportBatchRepository,
  PostgresExpenseReimbursementDepositRepository,
  PostgresExpenseTypeDeletionRequestRepository,
  PostgresExpenseTypeMasterRepository,
  ...
  PostgresRetroactiveCandidateQuery,
  PostgresSharedTalkRoomRepository,
  PostgresStatementImportJobRepository,
  PostgresTransactionCandidateRepository,
  PostgresTransactionListQuery,
...
export async function createDeps(env: CompositionEnv): Promise<AppDeps> {
  ...
  const lineChannelConfigQuery = new PostgresLineChannelConfigQuery(db)
  ...
  return {
    ...
    transactionListQuery: new PostgresTransactionListQuery(db, {
      resolveCategoryNames,
      resolveViewerRole,
    }),
    ...
    resolveViewerRole,
    categoryMasterRepository: new PostgresCategoryMasterRepository(db),
    expenseTypeMasterRepository: new PostgresExpenseTypeMasterRepository(db),
    monthlyLimitRepository: new PostgresMonthlyLimitRepository(db),
    categoryDeletionRequestRepository: new PostgresCategoryDeletionRequestRepository(db),
    expenseTypeDeletionRequestRepository: new PostgresExpenseTypeDeletionRequestRepository(db),
    transactionRepository: new PostgresTransactionRepository(db),
    statementImportJobRepository: new PostgresStatementImportJobRepository(db),
    transactionCandidateRepository: new PostgresTransactionCandidateRepository(db),
    dailyMailImportBatchRepository: new PostgresDailyMailImportBatchRepository(db),
    ...
    expenseReimbursementDepositRepository: new PostgresExpenseReimbursementDepositRepository(db),
    monthlyReportRepository: new PostgresMonthlyReportRepository(db),
    mitsuiSumitomoUnpaidRepository: new PostgresMitsuiSumitomoUnpaidRepository(db),
    deliveryMessageRepository: new PostgresDeliveryMessageRepository(db),
