...
> Plan Task 5 で各コンテキストファイルを作成後、本表のリンクを更新する。

| ファイル | コンテキスト | サブドメイン |
|---|---|---|
| `08a-ul-取引取込.md` | 取引取込 | Supporting |
| `08b-ul-自動分類学習.md` | 自動分類・学習 | Core |
| `08c-ul-家計分析.md` | 家計分析 | Core |
| `08d-ul-残高資産推移管理.md` | 残高・資産推移管理 | Core |
| `08e-ul-経費精算.md` | 経費精算 | Core |
| `08f-ul-オンボーディング認証.md` | オンボーディング・認証 | Supporting |
| `08g-ul-通知配信.md` | 通知配信 | Generic |
| `08h-ul-マスタ管理.md` | マスタ管理 | Supporting |
